class Enemy {
    ...
    draw(context) {
        if (this.game.debug) context.strokeRect(this.x, this.y, this.width, this.height);  // draw rect for debug mode
...
export class FlyingEnemy extends Enemy {
    constructor(game) {
        ...
        this.width = 60;
        this.height = 44;
        this.x = this.game.width + Math.random() * this.game.width * 0.5;  // random enemy frequence
        this.y = Math.random() * this.game.height * 0.5;                   // random enemy altitude
